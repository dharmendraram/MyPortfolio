...
const socials = [
  ...
  },
  {
    ...
    label: "GitHub",
    color: "hover:text-neutral-100 hover:border-neutral-400",
  },
  {
    icon: <BsWhatsapp />,
...
const Contact = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    window.open(
      `https://wa.me/9779819745073?text=${encodeURIComponent(message)}`,
      "_blank",
      "noopener,noreferrer"
    );
      ...
      <div className="relative z-10 px-4 sm:px-6 md:px-8 lg:px-12 xl:px-16">
        ...
        <div className="mb-5 ">
          ...
          <p className={`mt-3 text-sm sm:text-base max-w-xl ${isDark ? "text-neutral-400" : "text-slate-600"}`}>
            Have a project in mind, an opportunity, or a technical question? Reach out through the form or direct channels below.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-start">
          ...
          <div className="lg:col-span-6 space-y-6">
            {/* Status Card */}
            <div
              className={`p-6 sm:p-7 rounded-3xl border backdrop-blur-xl transition-all duration-300 ${
                isDark
                  ? "bg-white/[0.02] border-white/10"
                  : "bg-white border-slate-200 shadow-sm"
              }`}
            >
              <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full text-xs font-medium text-emerald-600 dark:text-emerald-400 bg-emerald-500/10 border border-emerald-500/20 mb-4">
                <span className="w-2 h-2 rounded-full bg-emerald-500 animate-ping" />
                <span>Open for Commissions & Full-Time Roles</span>
              </div>
            ...
            <div className="space-y-2 grid grid-cols-2 gap-3">
              <a
                ...
                className={`flex items-center gap-4 p-4 rounded-2xl border transition-all duration-200 group ${
                  isDark
                    ? "bg-white/[0.02] border-white/10 hover:border-teal-500/40 hover:bg-white/[0.05]"
                    : "bg-white border-slate-200 hover:border-teal-500/40 hover:bg-slate-50 shadow-sm"
                }`}
              >
                ...
                <div>
                  <span className="text-xs text-slate-500 dark:text-neutral-400 block font-medium">
                    Direct Email
                  </span>
                  <span className="text-sm font-semibold text-slate-800 dark:text-neutral-200 group-hover:text-teal-500 dark:group-hover:text-teal-400 transition-colors">
              ...
              >
                ...
                <div>
                  ...
                  <span className="text-sm font-semibold text-slate-800 dark:text-neutral-200 group-hover:text-cyan-500 dark:group-hover:text-cyan-400 transition-colors">
                    +977 9819745073
                  </span>
                </div>
              </a>
            ...
            >
              <span className="text-xs font-semibold text-slate-500 dark:text-neutral-400 uppercase tracking-wider block mb-3">
              ...
              <div className="flex flex-wrap gap-2.5">
                {socials.map((item) => (
                  <a
                    ...
                    className={`w-10 h-10 rounded-xl border flex items-center justify-center text-base transition-all duration-200 ${
                      isDark
                        ? "border-white/10 bg-white/[0.04] text-neutral-300 hover:bg-white/[0.1] " +
                          item.color
          ...
          <div className="lg:col-span-6">
            <div
              className={`p-6 sm:p-8 rounded-3xl border backdrop-blur-xl transition-all duration-300 ${
                isDark
                  ? "bg-white/[0.02] border-white/10 shadow-xl shadow-black/20"
                ...
                <div className="mb-6 p-4 rounded-2xl bg-emerald-500/10 border border-emerald-500/30 text-emerald-600 dark:text-emerald-400 flex items-center gap-3 text-sm">
                  ...
                  <div>
                    ...
                    <span className="text-xs opacity-90">
                      Your inquiry has been recorded and WhatsApp opened to complete sending.
                    </span>
                  </div>
                </div>
              )}
