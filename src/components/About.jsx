...
const About = () => {
  ...
  const corePillars = [
    {
      title: "Government & Civic Platforms",
      desc: "Built digital platforms for governance and provincial research organizations.",
    },
    {
      title: "Hospital Management Systems (HMS)",
      desc: "Led development of Hamro HMS handling patient registration, records, and operations.",
    },
    {
      title: "Enterprise Backend & REST APIs",
      desc: "Architected high-throughput relational databases with Django, Grails, and PostgreSQL.",
    },
    {
      title: "Modern Reactive Frontends",
      desc: "Engineered scalable single-page apps using React, TypeScript, and modern state architecture.",
    },
  ];
    ...
    >
      <div className="relative z-10 px-4 sm:px-6 md:px-8 lg:px-12 xl:px-14 ">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-5 lg:gap-5 items-center">
          {/* Left Column: Portrait Card & Technical Focus */}
          <div className="lg:col-span-4 flex flex-col items-center lg:items-start">
            ...
            >
              ...
              <div className="flex flex-wrap gap-2 pt-1">
                <span className="px-2.5 py-1 text-[11px] font-medium rounded-lg bg-teal-500/10 text-teal-600 dark:text-teal-300 border border-teal-500/20">
                  Full-Stack Developer
                </span>
                <span className="px-2.5 py-1 text-[11px] font-medium rounded-lg bg-cyan-500/10 text-cyan-600 dark:text-cyan-300 border border-cyan-500/20">
                  NIRC Nepal
                </span>
                <span className="px-2.5 py-1 text-[11px] font-medium rounded-lg bg-blue-500/10 text-blue-600 dark:text-blue-300 border border-blue-500/20">
                  React · Django · Grails
                </span>
              </div>
            </div>
          ...
          {/* Right Column: Editorial Bio & Pillars */}
          <div className="lg:col-span-8">
            ...
            <div className={`space-y-4 text-sm sm:text-base leading-relaxed ${
              ...
              <p>
                I am <span className="font-semibold text-slate-900 dark:text-white">Dharmendra Kumar Ram</span>, a Full-Stack Software Developer currently engineering enterprise and public sector web platforms at the{" "}
                <span className="text-teal-600 dark:text-teal-400 font-medium">National Incubation & Research Center (NIRC)</span> in Nepal.
              </p>
              <p>
                With a Bachelor’s in Computer Application (BCA) from Tribhuvan University, I combine a rigorous foundation in computer science with modern engineering practices. Over the past several years, I have architected and delivered mission-critical applications including the <span className="font-semibold text-slate-800 dark:text-neutral-100">Hospital Management System (Hamro HMS)</span>, the <span className="font-semibold text-slate-800 dark:text-neutral-100">Government With People (GWP)</span> citizen portal, Rakmina Recruitment, and provincial training portals.
              </p>
              <p>
                My approach focuses on clean code, testable architectures, performant relational database schemas (MySQL & PostgreSQL), secure authentication pipelines, and fluid UI experiences built with React, TypeScript, and modern CSS tooling.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3.5 mt-8 mb-8">
              {corePillars.map((pillar, idx) => (
                ...
                >
                  ...
                  <p className="text-[12px] text-slate-500 dark:text-neutral-400 leading-snug">
                    {pillar.desc}
                  </p>
                </div>
              ))}
